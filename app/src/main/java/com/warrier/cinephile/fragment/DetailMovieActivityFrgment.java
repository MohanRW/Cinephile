...
import com.warrier.cinephile.adapter.CastAdapter;
import com.warrier.cinephile.adapter.CrewAdapter;
import com.warrier.cinephile.adapter.GenreAdapter;
import com.warrier.cinephile.adapter.ReviewAdapter;
import com.warrier.cinephile.adapter.SimilarMovieArrayAdapter;
import com.warrier.cinephile.adapter.VideoAdapter;
import com.warrier.cinephile.asynctask.FetchMovieDetail;
...
import com.warrier.cinephile.utils.PaletteTransformation;
...
import static com.warrier.cinephile.utils.Constants.CAST_COLUMNS;
import static com.warrier.cinephile.utils.Constants.COL_VIDEOS_KEY;
import static com.warrier.cinephile.utils.Constants.CREW_COLUMNS;
import static com.warrier.cinephile.utils.Constants.FAVOURITE_MOVIE_COLUMNS;
import static com.warrier.cinephile.utils.Constants.GENRE_COLUMNS;
import static com.warrier.cinephile.utils.Constants.MOVIE_DETAILS_COLUMNS;
import static com.warrier.cinephile.utils.Constants.MOV_COL_BACKDROP_PATH;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_BUDGET;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_HOMEPAGE;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_ORIGINAL_LANGUAGE;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_ORIGINAL_TITLE;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_OVERVIEW;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_POSTER_PATH;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_RELEASE_DATE;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_REVENUE;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_RUNTIME;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_STATUS;
import static com.warrier.cinephile.utils.Constants.MOV_DETAILS_COL_VOTE_AVERAGE;
import static com.warrier.cinephile.utils.Constants.REVIEW_COLUMNS;
import static com.warrier.cinephile.utils.Constants.SIMILAR_MOVIE_COLUMNS;
import static com.warrier.cinephile.utils.Constants.VIDEO_COLUMNS;

/**
 * Created by Galahad on 17/11/2017.
 */

public class DetailMovieActivityFrgment  extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, AsyncResponse {

    private static final String LOG_TAG = DetailMovieActivityFrgment.class.getSimpleName();
    ...
    private CrewAdapter crewListAdapter;
    ...
    public DetailMovieActivityFrgment() {
    ...
    private void populateAdapters() {
        ...
        if (mActivity != null) {
            ...
            crewListAdapter = new CrewAdapter(mActivity.getContentResolver().query(
            ...
            castListAdapter = new CastAdapter(mActivity.getContentResolver().query(
            ...
            videoListAdapter = new VideoAdapter(mActivity.getContentResolver().query(
            ...
            ReviewAdapter reviewListAdapter = new ReviewAdapter(mActivity.getContentResolver().query(
            ...
            GenreAdapter genreListAdapter = new GenreAdapter(mActivity.getContentResolver().query(
            ...
            similarMovieListAdapter.setOnClickListener(new SimilarMovieArrayAdapter.SetOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    DetailMovieActivityFrgment fragment = new DetailMovieActivityFrgment();
            ...
            videoListAdapter.setOnClickListener(new VideoAdapter.SetOnClickListener() {
                @Override
                public void onItemClick(int position) {
            ...
            if (!(mCursor == null || !(mCursor.moveToFirst()) || mCursor.getCount() == 0)) {
                firstVideoLink += mCursor.getString(COL_VIDEOS_KEY);
                mCursor.close();
            }
            ...
            castListAdapter.setOnClickListener(new CastAdapter.SetOnClickListener() {
                @Override
                public void onItemClick(int position) {
            ...
            crewListAdapter.setOnClickListener(new CrewAdapter.SetOnClickListener() {
                @Override
                public void onItemClick(int position) {
